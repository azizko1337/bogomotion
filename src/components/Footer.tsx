...
function Footer(props: Props) {
  const { user } = props;
  return (
    <footer className="flex flex-col justify-center bg-[#000000] absolute w-full text-xs font-bold text-white">
      <div className="flex gap-5 justify-between items-center py-5 pr-10 pl-1 w-full">
        <div className="flex gap-5 justify-between items-center px-16 ">
          ...
          <a
            href="https://www.instagram.com/uniwersytetslaski/"
            target="_blank"
          >
            <img
